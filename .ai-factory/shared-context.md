...
### Module Dependencies (import graph)
  ...
  pages/Rank.tsx → imports: components/ScreenScaffold, components/Card, components/StateView, components/FloatingTabBar, components/AdSlot, hooks/useProfile, lib/rankApi, lib/storage, lib/types
